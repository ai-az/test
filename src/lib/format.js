...
// رقم المادة للعرض، مع دعم «مكرر»: ١١ مكرر / 11 bis
export function displayArticleNumber(article, lang = "ar") {
  const base = displayNumber(article.articleNumber, lang);
  if (!article.mukarrar) return base;
  return lang === "ar" ? `${base} مكرر` : `${base} bis`;
}
